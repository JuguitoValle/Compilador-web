...
origins = [
    ...
    "[https://tu-proyecto-en-vercel.app](https://tu-proyecto-en-vercel.app)", # (Opcional) Tu dominio de producción cuando lo tengas
    "*" # Comodín: Permite a cualquiera conectarse (útil si tienes problemas al inicio)
]
